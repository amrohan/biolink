...
You can replace `3000` with any port number you prefer.
...
The backend will now be running locally. By default, it will be available at [http://localhost:3000](http://localhost:3000) (or the port you specified in the `.env` file).
...
The frontend should now be available at [http://localhost:3001](http://localhost:3001) (or the port specified in the `.env` file, if applicable).
